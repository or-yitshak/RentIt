...
public class Post {
    ...
    private int price = 0; // price of the post.
     ...
     */
    public Post(String publisher_email, String category, String title, String description, String imageURL, String address, int price, String priceCategory) {
